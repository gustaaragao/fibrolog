...
- [x] 1.1 Atualizar `container.backgroundColor` de `#E6F4FE` para `#fdf2f9` (pink-50)
...
- [x] 2.1 Atualizar `titulo.color` de `#0066CC` para `#7d1e60` (pink-800)
- [x] 2.2 Atualizar `titulo.marginBottom` para `8` (consistente com login)
- [x] 2.3 Atualizar `subtitulo.color` de `#666` para `#b5228a` (pink-600)
- [x] 2.4 Atualizar `subtitulo.marginBottom` para `48` (consistente com login)

## 3. Adicionar labels aos campos de input

- [x] 3.1 Criar estilo `label` com color `#7d1e60`, fontSize `16`, fontWeight `600`, marginBottom `8`
...
- [x] 4.1 Atualizar `input.borderColor` de `#ddd` para `#facfe9` (pink-200)
- [x] 4.2 Adicionar `input.color` com valor `#7d1e60` (pink-800)
- [x] 4.3 Atualizar `placeholderTextColor` para `#999` em todos os TextInput

## 5. Atualizar cores do botão principal

- [x] 5.1 Atualizar `botao.backgroundColor` de `#0066CC` para `#D330AA` (pink-500)
- [x] 5.2 Substituir estilo `botaoDesabilitado` com `opacity: 0.6` por `backgroundColor: #f7a9d7` (pink-300)
- [x] 5.3 Adicionar `marginTop: 16` no botão principal para consistência

## 6. Atualizar cores do botão de navegação

- [x] 6.1 Atualizar `textoVoltar.color` de `#0066CC` para `#b5228a` (pink-600)
